...
use App\Utils\PermissionQueries\Eloquent\Priority as EloquentPriorityQueries;
...
class PriorityResource extends Resource
{
     ...
     */
    public static $model = Priority::class;
    ...
    public function searchQuery(\Lomkit\Rest\Http\Requests\RestRequest $request, \Illuminate\Contracts\Database\Eloquent\Builder $query)
    {
        ...
        return EloquentPriorityQueries::make()->implementQuery($query);
    }
}
