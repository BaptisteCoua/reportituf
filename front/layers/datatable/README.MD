...
* Séparation totale entre la logique de gestion des données et l'affichage.
* Possibilité d'étendre la classe `ServerDataTable` pour des besoins métiers spécifiques à chaque équipe.
