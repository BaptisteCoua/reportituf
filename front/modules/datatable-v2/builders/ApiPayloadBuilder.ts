...
import type { LomkitPayload, GraphQLPayload } from '../types/ApiPayloadBuilder.types'
...
export class ApiPayloadBuilder {
  ...
  buildLomkit(params: ServerFetchParams): LomkitPayload {
    const payload: LomkitPayload = {
      pagination: {
        page: params.page,
  ...
  buildGraphQL(params: ServerFetchParams): GraphQLPayload {
