...
import type { ServerFetchParams } from "../src/types/ApiPayloadBuilder.types";
...
describe("Payload Builders Index", () => {
  ...
  it("defaultPayloadBuilder gère tous les paramètres", () => {
    ...
    const result = defaultPayloadBuilder(fullParams) as any;
  ...
  it("lomkitPayloadBuilder gère tous les paramètres", () => {
    ...
    const result = lomkitPayloadBuilder(fullParams) as any;
  ...
  it("graphqlPayloadBuilder gère tous les paramètres", () => {
    ...
    const result = graphqlPayloadBuilder(fullParams) as any;
