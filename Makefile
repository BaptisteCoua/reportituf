...
help:
	...
	@echo "  $(BLUE)Backend:$(RESET)       http://localhost:8001"
	@echo "  $(YELLOW)Mailpit:$(RESET)       http://localhost:8026"
	@echo "  $(MAGENTA)Elasticsearch:$(RESET) http://localhost:9201"
	@echo ""
...
up:
	...
	@echo "  ⚙️  $(BLUE)Backend:$(RESET)       http://localhost:8001"
	@echo "  📧 $(YELLOW)Mailpit:$(RESET)       http://localhost:8026"
	@echo "  🔍 $(MAGENTA)Elasticsearch:$(RESET) http://localhost:9201"
	@echo ""
